...
import { businessHours, contactMethods } from '../../assets/listing';
          ...
          <Card className="p-8">
            <CardContent className="p-0 space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                <Button onClick={handleWhatsAppClickOnContactUs} className="gap-2 bg-green-600 hover:bg-green-700">
                  <MessageCircle className="w-4 h-4" />
                  {t('BUTTONS.WHATSAPP_US_NOW')}
                </Button>
                <Button variant="outline" onClick={handleEmailClickOnContactUs} className="gap-2">
