...
export function Main({onNavigate, addToCart}: MainProps) {
  const {
    t
  } = useCustomHook();
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="px-8 py-3 gap-2" onClick={handleWhatsAppOrderFromSlider}>
